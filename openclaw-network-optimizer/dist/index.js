...
function windowsSnapshot(portNumber) {
    return [
...
function clashCliCommands(portNumber) {
...
function dnsAbTest(interfaceAlias) {
    return [
        '# DNS A/B test',
        '',
